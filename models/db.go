...
// NsPlatformAdvPosition NsPlatformAdvPosition
...
// NsMemberExpressAddress NsMemberExpressAddress
...
// NsAttributeValue NsAttributeValue
...
// NsGoodsCategory NsGoodsCategory
...
// NsMemberFavorites NsMemberFavorites
...
// NsGoodsEvaluate NsGoodsEvaluate
...
// NsGoodsAttribute NsGoodsAttribute
...
type SysAlbumPicture struct {
	...
	ShopID        uint   `orm:"column(shop_id);null" description:"所属实例id" json:"description"`
	AlbumID       uint   `orm:"column(album_id)" description:"相册id" json:"album_id"`
	IsWide        int    `orm:"column(is_wide)" description:"是否宽屏" json:"is_wide"`
	PicName       string `orm:"column(pic_name);size(100)" description:"图片名称" json:"pic_name"`
...
// NsGoodsSpecValue NsGoodsSpecValue
...
// NsOrderGoodsExpress NsOrderGoodsExpress
...
// NsExpressCompany NsExpressCompany
